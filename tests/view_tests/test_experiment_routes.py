...
def test_template_creation(client):
    ...
    subprocess.call(["touch", "elephant_vending_machine/static/experiment/test_file2.py"])
    subprocess.call(["touch", "elephant_vending_machine/static/experiment/empty.py"])
    data = {'name': "name", 'intermediate_duration': 5, 'stimuli_duration': 5, 'fixation_duration': 5, 'fixation_default': True, 'trials':2, 'replacement': "False", "monitors":'[true, false, true]', "fixation":"", "outcomes":'[["group1","treat1","tray1"]]'}
